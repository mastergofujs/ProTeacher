...
def parse_args(args):
    ...
    parser.add_argument("--exp_name", default="20_joint_former_final", type=str, help="exp name used for the training")
...
def main(args):
    ...
    stats = np.load(
        f"/home/gaolj/ConformerSED/exp/{cfg['exp_name']}/stats.npz",
    )
    ...
    output_dir = exp_name / "validation"
