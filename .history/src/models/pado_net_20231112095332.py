...
from models.baseline_model import CNN, LinearProjector
...
class SEDModel(torch.nn.Module):
    def __init__(
        ...
        self.projector = LinearProjector(64)
        ...
        self.encoder = Encoder(128, encoder_kwargs)
        ...
        if self.pooling == "attention":
            ...
            self.tag_token = torch.nn.Parameter(torch.zeros(1, 1, 128))
