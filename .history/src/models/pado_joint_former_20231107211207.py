import torch
from models.conformer.conformer_encoder1 import ConformerEncoder, ConformerMaskedEncoder, ConformerPromptedEncoder
...
class SEDModel(torch.nn.Module):
    def __init__(
        ...
        if encoder_type == "Transformer":
            ...
            self.encoder_masked = Pro(input_dim, **encoder_kwargs)
        else:
