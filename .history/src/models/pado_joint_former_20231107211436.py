import torch
from models.conformer.conformer_encoder1 import ConformerEncoder, ConformerMaskedEncoder, PromptedConformerMaskedEncoder
...
class SEDModel(torch.nn.Module):
    ...
    def forward(self, input, prompt_tuning=True):
        ...
        if self.pooling == "token":
            ...
            cls_token = False
        x, _ = self.encoder_masked(x, inds=(masked_inds, unmasked_inds), cls_token=cls_token, prompt_tuning=True)
