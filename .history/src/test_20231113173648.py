...
from models.pado_net import SEDModel 
...
def parse_args(args):
    ...
    parser.add_argument("--exp_name", default="19_trans_pado", type=str, help="exp name used for the training")
    ...
    parser.add_argument("--test_meta", default="/data0/gaolj/sed_data/DCASE2019/metadata/validation/validation.tsv")
    parser.add_argument("--test_audio_dir", default="/data0/gaolj/sed_data/DCASE2019/audio/validation/validation/")    
...
def test(model, test_loader, output_dir, options, pp_params={}):
    ...
    post_process.compute_psds() # syx 这个
...
def main(args):
    ...
    model = SEDModel(n_class=len(classes), cnn_kwargs=cfg["model"]["cnn"],
                    ...
                    #  decoder_kwargs=cfg["model"]["decoder"],
                    #  mask_kwargs=cfg["model"]["mask"]
                     )
    #%%
