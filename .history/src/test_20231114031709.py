...
def parse_args(args):
    ...
    parser.add_argument("--test_meta", default="/data0/gaolj/sed_data/DCASE2019/metadata/train/synthetic.tsv")
    parser.add_argument("--test_audio_dir", default="/data0/gaolj/sed_data/DCASE2019/audio/train/synthetic/")
